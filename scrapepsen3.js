      ...
      for (let i = 0; i < gamesData.length; i++) {
        if (!gamesData[i].url) {
          ...
          for (let a = 0; a < items.length; a++) {
            ...
            if (sim > 0.9 && gameConsole.toLowerCase().includes('ps4')) {
              if (gameType.toLowerCase() == 'ps vr game' || gameType.toLowerCase() == 'psn game' || gameType.toLowerCase() == 'full game' || gameType.toLowerCase() == 'level') {
